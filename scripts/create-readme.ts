...
const outputFile: string = join(cliDir, "95-readme-generator.sh");

/**
 * Generates the shell generator module (95-readme-generator.sh)
 * which dynamically outputs a customized README.md for scaffolded projects
 * based on selected features and package manager.
 */
function buildReadmeGenerator(): string {
	return `# ------------------------------------------------------------------------------
# Generate README.md
# ------------------------------------------------------------------------------
...
console.log("🔨 Writing cli/95-readme-generator.sh...");
writeFileSync(outputFile, buildReadmeGenerator(), "utf-8");
console.log("✔ cli/95-readme-generator.sh created.");
